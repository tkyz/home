...
if false; then
  ...
  # main
  {
    ...
    curl 'http://ftp.jaist.ac.jp/pub/eclipse/technology/epp/downloads/release/2019-06/R/eclipse-java-2019-06-R-linux-gtk-x86_64.tar.gz' | tar zxf - -C "${dir}" --strip-components 1 \
...
#   curl 'http://ftp.jaist.ac.jp/pub/mergedoc/pleiades/build/stable/pleiades.zip' | tar zxf - -C "${dir}" --strip-components 1 \
